...
export const SkillsSection = () => {
  ...
  return (
    ...
    >
      ...
      <div id="skill-section" className="w-full max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredSkills.map((skill, key) => (
            <div
              key={key}
              className="skill-card bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-lg hover:scale-105 transition-all duration-300"
            >
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-600 h-3 rounded-full overflow-hidden mb-2">
                <div
                  className="progress-bar bg-gradient-to-r from-[#6859ba] to-[#7767d2] h-3 rounded-full transition-all duration-1000 ease-out"
